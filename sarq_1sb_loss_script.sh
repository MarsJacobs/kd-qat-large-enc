...
bash run_SARQ-1step.sh $1 $2 0 0 0 1 base

# AttnMap + Context/Output
bash run_SARQ-1step.sh $1 $2 0 1 1 0 base
bash run_SARQ-1step.sh $1 $2 0 1 0 1 base
...
bash run_SARQ-1step.sh $1 $2 0 0 0 1 large

# AttnMap + Context/Output
bash run_SARQ-1step.sh $1 $2 0 1 1 0 large
bash run_SARQ-1step.sh $1 $2 0 1 0 1 large
