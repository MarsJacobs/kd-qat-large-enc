...
def main():
    ...
    for epoch_ in range(int(num_train_epochs)):
        ...
        for batch in train_dataloader:
            ...
            if args.rep_distill:
                count = 0
                kd_layer_num = args.kd_layer_num
                for i, (student_rep, teacher_rep) in reversed(list(enumerate(zip(student_reps, teacher_reps)))):
                    if i % (student_config.num_hidden_layers / 6) == 0 and count <= kd_layer_num:
