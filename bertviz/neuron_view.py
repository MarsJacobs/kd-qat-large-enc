...
def show(model, model_type, tokenizer, sentence_a, sentence_b=None, display_mode='dark', layer=None, head=None, input_ids=None):
    ...
    attn_data = get_attention(model, model_type, tokenizer, sentence_a, sentence_b, include_queries_and_keys=True, input_ids=input_ids)
    if model_type == 'gpt2':
        bidirectional = False
    else:
        bidirectional = True
...
def get_attention(model, model_type, tokenizer, sentence_a, sentence_b=None, include_queries_and_keys=False, input_ids=None):
